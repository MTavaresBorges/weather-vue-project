...
<script setup>
  ...
  const mapboxAPIKey = "pk.eyJ1IjoibWF0aGV1c2d0NyIsImEiOiJjbTJxZXhjNTAxMWM0MmpxM2Q1dWp6Ym1qIn0.ztH-XR865MlCisdd_j5Ezw";
  ...
  const getSearchResults = () => {
    ...
    queryTimeout.value = setTimeout(async () => {
      if (searchQuery.value !== "") {
        try{
          const result = await axios.get(`https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(searchQuery.value)}.json?access_token=${mapboxAPIKey}&types=place`);
